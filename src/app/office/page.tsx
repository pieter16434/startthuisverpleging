    ...
    <div style={{ minHeight: '100vh', background: '#F1ECE0', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: '"Bricolage Grotesque", system-ui, sans-serif', padding: '24px' }}>
      <div style={{ width: '100%', maxWidth: 420 }}>
        <div style={{ textAlign: 'center', marginBottom: 40 }}>
          ...
          <p style={{ color: '#6E6B62', fontSize: 13, marginTop: 6 }}>Kantoorportaal</p>
        </div>
        <div style={{ background: '#FBF8F2', border: '1px solid #D8D0C0', borderRadius: 16, padding: '40px 36px', boxShadow: '0 4px 24px rgba(26,26,23,0.06)' }}>
          ...
          <p style={{ color: '#6E6B62', fontSize: 14, marginBottom: 28 }}>Voer uw kantoorgegevens in.</p>
          <form onSubmit={handleLogin}>
            <div style={{ marginBottom: 16 }}>
              <label style={{ display: 'block', fontSize: 13, fontWeight: 600, color: '#3A3A33', marginBottom: 6 }}>E-mailadres</label>
              <input type="email" value={email} onChange={e => setEmail(e.target.value)} required placeholder="antwerpen@organisatie.be" style={inputStyle} />
            </div>
